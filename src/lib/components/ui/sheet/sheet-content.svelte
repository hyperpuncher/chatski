...
<SheetPortal {...portalProps}>
	...
	>
		...
		<SheetPrimitive.Close
			class="absolute top-4 opacity-70 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none end-4 rounded-xs ring-offset-background focus-visible:ring-ring focus-visible:outline-hidden"
		>
			<XIcon class="size-4" />
